  ...
  return (
    <div className="relative group w-full border-b border-[#2b2b2b] focus-within:border-white transition-colors pt-4">
      <input
        type={type}
        placeholder=" "
        className="peer w-full bg-transparent pb-1.5 text-[#2b2b2b] placeholder-transparent focus:outline-none transition-colors border-none text-xs sm:text-sm lg:text-base font-normal uppercase tracking-[0.12em] sm:tracking-wider"
        {...props}
      />
      ...
      <div className="relative z-10 w-full max-w-[1700px] mx-auto px-5 sm:px-6 md:px-10 lg:pl-36 lg:pr-24 xl:pl-48 xl:pr-32 pt-20 sm:pt-24 md:pt-24 lg:pt-20 pb-10 sm:pb-12 md:pb-14 lg:pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 md:gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex flex-col w-full md:col-span-2 xl:col-span-1 md:max-w-2xl xl:max-w-none md:mx-auto xl:mx-0">
            <form className="flex flex-col space-y-4 lg:space-y-5 w-full">
              <FloatingInput label="Select Opportunity" />
              <FloatingInput label="Your Name" />
              <FloatingInput label="Email Address" type="email" />
              <FloatingInput label="Contact Number" type="tel" />
              <FloatingInput label="Website URL" type="url" />
              <FloatingInput label="Enter Message" />

              <button type="submit" className="bg-[#000000] text-white font-gilroy font-bold tracking-widest text-xs sm:text-sm py-3 lg:py-4 px-7 sm:px-8 self-start hover:bg-white hover:text-black transition-colors mt-4">
                SEND
              </button>
            </form>
          </div>
